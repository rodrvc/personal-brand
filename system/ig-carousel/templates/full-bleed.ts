 ...
 * Photo fills the entire 4:5 frame; a dark gradient (transparent -> petrol)
 * sits over the bottom third with title/subtitle/meta in white text.
 * Poster/story look.
 */
export const renderFullBleed: SlideTemplate = (slide: Slide) => {
  const styles = `
    ...
    .overlay {
      ...
      height: 42%;
      background: linear-gradient(to bottom, rgba(26,95,122,0) 0%, rgba(26,95,122,0.55) 45%, rgba(26,95,122,0.92) 100%);
