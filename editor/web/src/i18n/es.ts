...
export const es = {
  ...
  "selectionPane.fontWeightRegular": "Regular",
  "selectionPane.fontWeightSemibold": "Seminegrita",
  "selectionPane.fontWeightBold": "Negrita",
  ...
  "editor.deleteBlocked": "Este objeto está bloqueado: desbloquéalo primero para poder eliminarlo.",
  "editor.conflictReloaded":
    "Este carrusel cambió en otra pestaña o por el chat. Se cargó la versión guardada; tus últimos cambios sin guardar no se aplicaron.",

  // AI chat (editor/ChatPanel.tsx)
  "chat.title": "Chat",
  "statusBar.spend": "Gasto: {amount}",
  "statusBar.spendItem": "{when} · imagen generada · {amount}",
  "statusBar.spendReply": "{when} · respuesta del chat · {amount}",
  "statusBar.spendNone": "Todavía no hay gasto en este carrusel.",
  "chat.expand": "Abrir el chat",
  "chat.collapse": "Colapsar el chat",
  "chat.pendingBadge": "Propuesta",
  "chat.emptyHint": "Pide un cambio concreto: «en la 3 pon de fondo una playa». Puedes arrastrar imágenes aquí como referencia. Cada propuesta espera tu visto bueno.",
  "chat.placeholder": "¿Qué corrijo?",
  "chat.send": "Enviar",
  "chat.thinking": "Pensando…",
  "chat.failedEvent": "No se aplicó: {error}. Lo que ya se generó quedó en la biblioteca y en el gasto.",
  "chat.startedEvent": "Aplicando la propuesta…",
  "chat.doneEvent": "Listo: terminó de aplicarse. Cambió la lámina {slides}. Costo: {amount}.",
  "chat.runningHeading": "En progreso: aplicando y generando…",
  "chat.runningBadge": "En progreso",
  "chat.referenceRole": "Tipo de referencia",
  "chat.referenceRole.layout": "carrusel",
  "chat.referenceRole.content": "imagen",
  "chat.referenceRemove": "Quitar la referencia",
  "chat.proposalHeading": "Propuesta",
  "chat.apply": "Aplicar",
  "chat.applying": "Aplicando…",
  "chat.discard": "Descartar",
  "chat.waitSave": "Guardando cambios…",
  "chat.piece.background": "el fondo",
  "chat.piece.text": "el texto",
  "chat.piece.wholeSlide": "todo su contenido no fijado (lo reemplaza la imagen nueva)",
  "chat.piece.textQuoted": "el texto «{text}»",
  "chat.piece.image": "una imagen suelta",
  "chat.piece.imageInSlot": "la imagen de {slot}",
  "chat.kind.cover": "de portada",
  "chat.kind.step": "de contenido",
  "chat.kind.closing": "de cierre",
  "chat.action.setText": "Lámina {n}: cambiar {piece} a «{text}»",
  "chat.action.setVisual": "Lámina {n}: poner en {piece} una imagen de la biblioteca",
  "chat.action.generateVisual": "Lámina {n}: generar una imagen nueva para {piece} (se cobra al aplicar)",
  "chat.action.generateLoose": "Lámina {n}: generar un objeto nuevo sin fondo y dejarlo suelto para que lo muevas (se cobra al aplicar)",
  "chat.action.addSlideFirst": "Agregar una lámina {kind} al principio",
  "chat.action.addSlide": "Agregar una lámina {kind} después de la {n}",
  "chat.action.composeOn": "Lámina {n}: generar una imagen igual al afiche de referencia, con los datos del evento nuevo, y ponerla a lámina completa (se cobra al aplicar)",
  "chat.action.composeNew": "Nueva lámina: generar una imagen igual al afiche de referencia, con los datos del evento nuevo, a lámina completa (se cobra al aplicar)",
  "chat.action.deleteObject": "Lámina {n}: quitar {piece} (queda guardada una versión)",
  "chat.action.deleteSlide": "Borrar la lámina {n} (queda guardada una versión)",
  "chat.provenance.template": "Del template: {detail}",
  "chat.provenance.document": "Del carrusel: lámina {detail}",
  "chat.provenance.free": "Suelto sobre la lámina {detail}, fuera de los huecos del template",
  "chat.provenance.library": "De la biblioteca: {detail}",
  "chat.provenance.generation": "Imagen nueva, con este pedido: «{detail}»",
  "chat.provenance.reference": "Con tu referencia, como imagen de entrada: {detail}",
  ...
  "chat.intact.onlyPieces": "En la lámina {n} solo cambia {pieces}; lo demás queda igual.",
} as const;
